...
if (file_exists(__DIR__ . '/setup.lock')) {
    http_response_code(403);
    exit('<h2 style="font-family:monospace;color:#e24b4a">Setup já executado. Remova setup.php do servidor.</h2>');
}
...
<div class="warn">⚠️ Troque as senhas imediatamente após o primeiro acesso. Remova setup.php do servidor.</div>
<p style="margin-top:1.5rem"><a href="<?=htmlspecialchars(BASE_URL)?>/index.php">→ Ir para o login</a></p>
</body></html>
